...
- Provider-owned remote administrative settings, transfers, file creation/rename/delete, Save As and final integration audit remain open. Native dirty-editor app quit and preference persistence still need walkthroughs. The goal is not complete at this checkpoint.
