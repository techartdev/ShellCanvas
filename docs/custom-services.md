...
Independent replacement of one source, persisted composite profiles, adapter SDK/schema generation and cross-platform native evidence remain separate [delivery gates](kernel-roadmap.md).
