...
- **Desktop:** installable themes, light/dark/system appearance, photo and landscape wallpapers, interface scale, toolbar/dock sizing, system/12/24-hour clock, seconds and reduced motion. See [themes and appearance](themes.md) for installation, authoring and recovery. The clock uses the local device timezone. OS reduced-motion styling remains effective regardless of the app switch.
