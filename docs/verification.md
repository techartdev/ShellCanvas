...
- Review what will be shared: exclude `.local`, credentials, host records, private terminal/file contents and debug artifacts not intended for distribution. The [public release process](public-release.md) defines hosted release-readiness and publication; commercial packaging remains a separate decision.
