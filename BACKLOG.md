...
Prioritize a dependable working desktop over adding protocols or more bundled apps. Delivered: terminal containment/actions, saved host CRUD, and independent host workspaces with session-bound app services. Next: CORE-08 Files context actions/clipboard, then transfers. Keep the composite-adapter architecture as a constraint rather than building every adapter now.
