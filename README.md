...
- SFTP directory browsing, filtering, parent/back navigation, UTF-8 previews, new folders, rename, and confirmed deletion of files/links/empty folders. [File-action behavior and limits](docs/file-actions.md).
